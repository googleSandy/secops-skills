...
| `CHROME_MANAGEMENT` | Chrome Management |
...
| `CLAUDE_COMPLIANCE_LOGS` | Claude Compliance Logs |
...
| `CYJAX_THREAT_INTELLIGENCE` | CYJAX Threat Intelligence |
...
| `GCP_ABUSE_EVENTS` | GCP Abuse Events Logs |
| `GCP_APIGEE` | Apigee |
| `GCP_APIGEE_X` | Apigee |
| `GCP_APP_ENGINE` | GCP_APP_ENGINE |
| `GCP_BIGQUERY_CONTEXT` | BigQuery |
| `GCP_CLOUDAUDIT` | GCP Cloud Audit |
| `GCP_CLOUDIDENTITY_DEVICES` | Cloud Identity Devices |
| `GCP_CLOUDIDENTITY_DEVICEUSERS` | Cloud Identity Device Users |
| `GCP_CLOUDIOT` | Cloud IoT |
| `GCP_CLOUDSQL` | Cloud SQL |
| `GCP_CLOUD_ASSET_INVENTORY` | GCP_CLOUD_ASSET_INVENTORY |
| `GCP_CLOUD_FUNCTIONS_CONTEXT` | Cloud Functions Context |
| `GCP_CLOUD_NAT` | Cloud NAT |
| `GCP_COMPUTE` | Compute Engine |
| `GCP_COMPUTE_CONTEXT` | Compute Context |
| `GCP_DNS` | Cloud DNS |
| `GCP_DNS_ATD` | Google Cloud DNS Threat Detector |
| `GCP_FIREWALL` | Firewall Rule Logging |
| `GCP_IAM_ANALYSIS` | Google Cloud IAM Analysis |
| `GCP_IAM_CONTEXT` | IAM Context |
| `GCP_IDS` | Cloud Intrusion Detection System |
| `GCP_KUBERNETES_CONTEXT` | GCP_KUBERNETES_CONTEXT |
| `GCP_LOADBALANCING` | Cloud Load Balancing |
| `GCP_MODEL_ARMOR` | GCP_MODEL_ARMOR |
| `GCP_MONITORING_ALERTS` | GCP_MONITORING_ALERTS |
| `GCP_NETWORK_CONNECTIVITY_CONTEXT` | GCP_NETWORK_CONNECTIVITY |
| `GCP_NGFW_ENTERPRISE` | NGFW Enterprise |
| `GCP_RECAPTCHA_ENTERPRISE` | reCAPTCHA Enterprise |
| `GCP_RESOURCE_MANAGER_CONTEXT` | Resource Manager Context |
| `GCP_RUN` | Cloud Run |
| `GCP_SECURITYCENTER_CHOKEPOINT` | Security Command Center Chokepoint |
| `GCP_SECURITYCENTER_ERROR` | Security Command Center Error |
| `GCP_SECURITYCENTER_EXTERNAL_EXPOSURE` | Security Command Center External Exposure |
| `GCP_SECURITYCENTER_MISCONFIGURATION` | Security Command Center Misconfiguration |
| `GCP_SECURITYCENTER_OBSERVATION` | Security Command Center Observation |
| `GCP_SECURITYCENTER_POSTURE_VIOLATION` | Security Command Center Posture Violation |
| `GCP_SECURITYCENTER_SECRET` | Security Command Center Secret |
| `GCP_SECURITYCENTER_SENSITIVE_DATA_RISK` | Security Command Center Sensitive Data Risk |
| `GCP_SECURITYCENTER_THREAT` | Security Command Center Threat |
| `GCP_SECURITYCENTER_TOXIC_COMBINATION` | Security Command Center Toxic Combination |
| `GCP_SECURITYCENTER_UNSPECIFIED` | Security Command Center Unspecified |
| `GCP_SECURITYCENTER_VULNERABILITY` | Security Command Center Vulnerability |
| `GCP_SQL_CONTEXT` | Cloud SQL Context |
| `GCP_STORAGE_CONTEXT` | Cloud Storage Context |
| `GCP_SWP` | GCP Secure Web Proxy |
| `GCP_THREATINTEL` | Google Threat Intelligence |
| `GCP_VPC_FLOW` | VPC Flow Logs |
...
| `GTI_IOC` | Google Threat Intelligence IOC |
...
| `MIMECAST_MAIL_V2` | Mimecast Mail V2 |
...
| `NETFLOW_OTEL` | OpenTelemetry Netflow Receiver |
...
| `RUBRIK_SECURITY_CLOUD` | Rubrik Security Cloud |
...
| `SAP_CHANGE_DOCUMENT` | SAP Change Document |
| `SAP_GATEWAY` | SAP Gateway |
| `SAP_HANA` | SAP HANA |
| `SAP_HANA_AUDIT` | SAP Hana Audit |
| `SAP_ICM` | SAP Internet Communication Manager |
| `SAP_IDENTITY_AND_AUTH_DATA` | SAP Identity and Authentication Data |
| `SAP_NETWEAVER` | SAP Netweaver |
| `SAP_SAST` | SAP SAST Suite |
| `SAP_SECURITY_AUDIT` | SAP Security Audit |
| `SAP_SM20` | SAP SM20 |
...
| `THREATCONNECT_IOC_V3` | ThreatConnect IOC V3 |
...
| `TRELLIX_EDRF` | Trellix EDRF Trace Data and Telemetry |
| `TRELLIX_HX_ALERTS` | Trellix HX Alerts |
| `TRELLIX_HX_AUDIT` | Trellix HX Audit Events |
| `TRELLIX_HX_ES` | Trellix HX Event Streamer |
| `TRELLIX_HX_HOSTS` | Trellix HX Hosts |
...
| `TRENDMICRO_VISION_ONE_ENDPOINT_VULNERABILITIES` | Trend Micro Vision One Endpoint Vulnerabilities |
...
| `ZSCALER_EMAIL_DLP` | Zscaler Email DLP |
