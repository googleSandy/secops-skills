...
### Limitations
If a batch UDM event size exceeds 8.2 MB, the raw logs and all the extracted fields are dropped. If a single UDM event exceeds 500 KB, the extracted fields are dropped.