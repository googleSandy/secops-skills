...
Reference files are scraped from Google's live documentation using a combination of a general recursive crawler and a specialized updater for structured tables.
...
![Prompt and Query](assets/prompt_query.png)

![Google SecOps UI Result](assets/secops_ui_result.png)
